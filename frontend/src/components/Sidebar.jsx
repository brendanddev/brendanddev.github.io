...
const Sidebar = () => {
  ...
  return (
    ...
    <motion.div
      ...
      className={`fixed left-0 top-0 h-full w-16 flex flex-col items-center justify-center ${theme.navbarBackground}/90 backdrop-blur-sm shadow-lg z-30 border-r border-gray-700`}
    >
